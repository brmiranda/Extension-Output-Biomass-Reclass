...
#define ExtensionName "Output Biomass Reclass"
...
AppId={{F62DACC0-F19E-4FDD-B85B-7FB2EEB1C39E}
...
Source: {#BuildDir}\Landis.Extension.Output.BiomassReclass-v3.2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Output Biomass Reclass 3.2.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Biomass Reclass v3.2"" "; WorkingDir: {#LandisPlugInDir}
