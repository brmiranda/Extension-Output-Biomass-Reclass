...
Source: {#BuildDir}\Landis.Extension.Output.BiomassReclass-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Biomass Reclass"" "; WorkingDir: {#LandisPlugInDir}
